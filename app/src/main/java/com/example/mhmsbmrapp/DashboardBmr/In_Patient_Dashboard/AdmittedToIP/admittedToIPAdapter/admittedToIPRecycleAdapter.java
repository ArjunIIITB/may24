package com.example.mhmsbmrapp.DashboardBmr.In_Patient_Dashboard.AdmittedToIP.admittedToIPAdapter;
...
public class admittedToIPRecycleAdapter extends RecyclerView.Adapter<admittedToIPRecycleAdapter.MyViewHolder> {

    private Context mContext ;
    private List<admittedToIPModelfile> mData ;
    RequestOptions option;


    public admittedToIPRecycleAdapter(Context mContext, List<admittedToIPModelfile> mData) {
    ...
    @NonNull
    @Override
    public admittedToIPRecycleAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view ;
        LayoutInflater inflater = LayoutInflater.from(mContext);
        view = inflater.inflate(R.layout.op_history_list,parent,false) ;
        final admittedToIPRecycleAdapter.MyViewHolder viewHolder = new admittedToIPRecycleAdapter.MyViewHolder(view) ;
    ...
    @Override
    public void onBindViewHolder(@NonNull admittedToIPRecycleAdapter.MyViewHolder holder, int position) {
